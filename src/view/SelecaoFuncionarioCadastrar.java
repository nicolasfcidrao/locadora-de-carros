 ...
 * @author alexandre
 */
public class SelecaoFuncionarioCadastrar extends javax.swing.JFrame {

    /**
     * Creates new form LoginCliente
     */
    public SelecaoFuncionarioCadastrar() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Selecione a opção que deseja cadastrar");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelecaoFuncionarioCadastrar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SelecaoFuncionarioCadastrar().setVisible(true);
            }
        });
    }
