...
public class SelecaoFuncionarioAlterar extends javax.swing.JFrame {

    /**
     * Creates new form LoginCliente
     */
    public SelecaoFuncionarioAlterar() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Selecione a opção que deseja alterar");
        ...
        jPanel1.add(btnCarro, gridBagConstraints);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelecaoFuncionarioAlterar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SelecaoFuncionarioAlterar().setVisible(true);
            }
        });
    }
